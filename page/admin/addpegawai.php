...
<head>
  ...
  <meta charset="utf-8">
  <meta name="description" content="Sistem Informasi Kepegawaian RSIA Muslimat">
  <meta name="author" content="Isna Nur Azis">
  <meta name="keyword" content="">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <title>Sistem Informasi Kepegawaian RSIA Muslimat</title>
            ...
            <div class="navbar-header" style="width:100%;">
              <div class="opener-left-menu is-open">
                ...
                <a href="index.html" class="navbar-brand"> 
                 <b>Sistem Informasi Kepegawaian RSIA Muslimat</b>
                </a>
              ...
              <div class="sub-left-menu scroll">
                <ul class="nav nav-list">
                    ...
                    <li class="time">
                     ...
                     <li class="active ripple"><a href="index.php"><span class="fa-home fa"></span>beranda</a></li>
                    <li class="ripple">
                      <a class="tree-toggle nav-header">
                        <span class=" icon-wrench fa"></span> Master Data
                        <span class="fa-angle-right fa right-arrow text-right"></span>
                      </a>
                      <ul class="nav nav-list tree">
                        <li><a href="topnav.html">Unit Kerja</a></li>
                      
                      </ul>
                    </li>
                    <li class="ripple">
                      <a class="tree-toggle nav-header">
                        <span class="fa-area-chart fa"></span> Grafik
                        <span class="fa-angle-right fa right-arrow text-right"></span>
                      </a>
                      <ul class="nav nav-list tree">
                        <li><a href="chartjs.html">Jabatan</a></li>
                        <li><a href="morris.html">Unit Kerja</a></li>
                        <li><a href="flot.html">Pendidikan</a></li>
                    ...
                    <li class="ripple"><a class="tree-toggle nav-header"><span class="fa fa-check-square-o"></span> Forms  <span class="fa-angle-right fa right-arrow text-right"></span> </a>
                      ...
                      <li class="ripple"><a href="?page=data_pegawai"><span class="fa fa-table"></span>Data Pegawai</a></li>

                       <li class="ripple"><a href="?page=data_pegawai"><span class="glyphicon glyphicon-transfer"></span>Mutasi</a></li>
                  
                    <li class="ripple"><a href="calendar.html"><span class="fa icon-graduation"></span>Riwayat Pendidikan</a></li>
                    <li class="ripple"><a class="tree-toggle nav-header"><span class="fa fa-child"></span> Riwayat Keluarga <span class="fa-angle-right fa right-arrow text-right"></span> </a>
                      <ul class="nav nav-list tree">
                        <li><a href="mail-box.html">Orang Tua</a></li>
                        <li><a href="compose-mail.html">Suami/Istri</a></li>
                        <li><a href="view-mail.html">Anak</a></li>
                      </ul>
                    </li>
                    <li class="ripple"><a class="tree-toggle nav-header"><span class="fa icon-user-follow"></span> Kepegawaian  <span class="fa-angle-right fa right-arrow text-right"></span> </a>
                      <ul class="nav nav-list tree">
                        <li><a href="forgotpass.html">Jabatan</a></li>
                        <li><a href="login.html">Pangkat</a></li>
                        <li><a href="reg.html">Hukuman</a></li>
                        <li><a href="article-v1.html">Diklat</a></li>
                        <li><a href="search-v1.html">Penghargaan</a></li>
                        <li><a href="productgrid.html">Penugasan</a></li>
                        <li><a href="profile-v1.html">Seminar</a></li>
                        <li><a href="invoice-v1.html">Cuti</a></li>
                         <li><a href="invoice-v1.html">Latihan Jabatan</a></li>
                         <li><a href="invoice-v1.html">Tunjangan</a></li>
                         <li><a href="invoice-v1.html">Izin Kawin</a></li>
                      </ul>
                    </li>
          ...
          <!-- start: Content -->
            <div id="content">
                  ...
                  <div class="panel-body">
                    <div class="col-md-12">
                        ...
                        <p class="animated fadeInDown">
                          Data Pegawai <span class="fa-angle-right fa"></span> Form Pegawai
                        </p>
                          <a href="#">
                           ...
                           <button name="tambah" type="submit" class="btn btn-success btn-sm btn-next" data-last="Finish">
                                     ...
                                     Import Data (excel)
                                   <i class="fa fa-file-excel-o icon-on-left" aria-hidden="true"></i>
                                    </button>
                           </a>
                    </div>
                  </div>
                ...
                <div class="form-element">
                        ...
                        <div class="panel-heading">
                         ...
                         <div class="panel-body" style="padding-bottom:30px;">
                          <div class="col-md-12">
                            ...
                            <div class="form-group"><label class="col-sm-2 control-label text-right">Tempat, Tanggal Lahir </label>
                              <div class="col-sm-5"><input type="text" name="nama" class="form-control"></div>

                                <div class="col-sm-5"><input type="date" name="tanggal_lahir" size="5"  ><span> <i class="fa fa-calendar"></i></span></div>
                            ...
                            <div class="form-group"><label class="col-sm-2 control-label text-right">Pilih Agama</label>
                              <div class="col-sm-10" >
                              
                                 <select class="select2-A" name="agama">
                          <optgroup label="..............">
                  ...
                  <label class="col-sm-2 control-label text-right" for="exampleInputPassword1">Pilih Agama</label>
                   <select class="select2-A" name="agama">
                          <optgroup label="..............">
                            ...
                            <option value="KongHucu">KongHucu</option>
                              ...
                              <div class="col-sm-10">
                                <div class="col-sm-12 padding-0">
                                  <input type="radio" name="laki"> Laki-Laki
                                </div>
                                <div class="col-sm-12 padding-0">
                                  <input type="radio" name="pr"> Peremmpuan
                                </div>
                              </div>
                            </div>
                      ...
                      <div class="form-group"><label class="col-sm-2 control-label text-right">Golongan Darah</label>
                              <div class="col-sm-10">
                                 ...
                                 <select class="select2-A" name="goldar">
                          <optgroup label="..............">
                            ...
                            <option value="B">B</option>
                             ...
                             <div class="form-group"><label class="col-sm-2 control-label text-right">No HP</label>
                              <div class="col-sm-10"><input type="text" name="hp" class="form-control"></div>
                            </div>
