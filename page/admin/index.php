...
?>
  ...
  <meta charset="utf-8">
  <meta name="description" content="SIMPEG RSIA Muslimat Jombang">
  <meta name="author" content="Isna Nur Azis">
  <meta name="keyword" content="">
  <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>SIMPEG RSIAM JBG</title>
            ...
            <div id="content">
                        ...
                        if(!isset($_GET["page"])){
                            require"welcome.php";
                                    ...
                                    if($_GET['page'] == "data_pegawai"){
                                    ...
                                    }else if($_GET['page'] == "data_kelas2"){
                                        require "data_kelas2.php";
                                    }else if($_GET['page'] == "data_kelas3"){
                                        require "data_kelas3.php";
                                    }else if($_GET['page'] == "data_kelas4"){
                                        require "data_kelas4.php";
                                        ...
                                        require "input_nilai.php";
                                    }else if($_GET['page'] == "notif"){
                                        require "notif.php";
                                    }else if($_GET['page'] == "catatan_pertumbuhan"){
                                        require "catatan_pertumbuhan.php";
                                    }else if($_GET['page'] == "data_pertumbuhan"){
                                        require "data_petubuhan.php";
                                    }else if($_GET['page'] == "catatan_siswa"){
                                        require "catatan_siswa.php";
                                    }else if($_GET['page'] == "lihat_catatan"){
                                        require "lihat_catatan.php";
                                    }else if($_GET['page'] == "siswa"){
                                        require "data_siswa2.php";
                                    }else if($_GET['page'] == "list_pertumbuhan"){
                                        require "list_pertumbuhan.php";
                                    }else if($_GET['page'] == "tambah_catatan"){
                                        require "tambah_catatan.php";
                                    }else if($_GET['page'] == "grafik"){
                                        require "grafik.php";
                                    }else if($_GET['page'] == "grafik2"){
                                        require "grafik2.php";
                                    }else if($_GET['page'] == "data_mingguan"){
                                        require "data_mingguan.php";
                                    }else if($_GET['page'] == "feedback"){
                                        require "feedback_b.php";
                                    }else if($_GET['page'] == "detail_feed"){
                                        require "detail_feed.php";
                                    }else if($_GET['page'] == "feedback_s"){
                                        require "feedback_s.php";
                                    }
                                    else{
